...
public class ShangjiaguanliEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ShangjiaguanliEntity() {

	}

	public ShangjiaguanliEntity(T t) {
		try {
    ...
    public String toString() {
        return "Shangjiaguanli{" +
            ...
            ", username=" + username +
            ", password=" + password +
            ", shangjiaguanliName=" + shangjiaguanliName +
            ", shangjiaguanliPhone=" + shangjiaguanliPhone +
            ", shangjiaguanliIdNumber=" + shangjiaguanliIdNumber +
            ", shangjiaguanliPhoto=" + shangjiaguanliPhoto +
            ", sexTypes=" + sexTypes +
