                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <%--<div class="form-group col-md-6">--%>
                                        ...
                                        <%--<input id="shangjiaValue" name="shangjiaValue" class="form-control"--%>
                                               <%--placeholder="商家" readonly>--%>
                                    <%--</div>--%>
                                    <div class="form-group col-md-6 aaaaaa">
                                        <label>积分商品</label>
                                        <div>
                                            <select id="jifengoodsSelect" name="jifengoodsSelect"
                                                    class="selectpicker form-control"  data-live-search="true"
                                                    title="请选择" data-header="请选择" data-size="5" data-width="650px">
                                            </select>
                                        </div>
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="jifengoodsId" name="jifengoodsId" type="hidden">
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
           ...
           if($("#jifengoodsId") !=null){
               var jifengoodsId = $("#jifengoodsId").val();
               if(jifengoodsId == null || jifengoodsId =='' || jifengoodsId == 'null'){
                   alert("商品不能为空");
                   return;
               }
           }
            ...
            httpJson("jifengoodsOrder/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
    ...
    // 查询列表
        ...
        function jifengoodsSelect() {
            //填充下拉框选项
            http("jifengoods/page?page=1&limit=100&sort=&order=", "GET", {}, (res) => {
                if(res.code == 0){
                    jifengoodsOptions = res.data.list;
                }
            });
        }

        function jifengoodsSelectOne(id) {
            http("jifengoods/info/"+id, "GET", {}, (res) => {
                if(res.code == 0){
                ruleForm = res.data;
                jifengoodsShowImg();
                jifengoodsShowVideo();
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationjifengoodsSelect() {
            var jifengoodsSelect = document.getElementById('jifengoodsSelect');
            if(jifengoodsSelect != null && jifengoodsOptions != null  && jifengoodsOptions.length > 0 ) {
                for (var i = 0; i < jifengoodsOptions.length; i++) {
                        jifengoodsSelect.add(new Option(jifengoodsOptions[i].jifengoodsName, jifengoodsOptions[i].id));
                }

                $("#jifengoodsSelect").change(function(e) {
                        jifengoodsSelectOne(e.target.value);
                });
            }
    ...
    function setSelectOption() {
        ...
        <!--  级联表的下拉框回显  -->
            ...
            if(jifengoodsSelect != null && jifengoodsOptions != null  && jifengoodsOptions.length > 0 ) {
                for (var i = 0; i < jifengoodsOptions.length; i++) {
                    if (jifengoodsOptions[i].id == ruleForm.jifengoodsId) {//下拉框value对比,如果一致就赋值汉字
                        jifengoodsSelect.options[i+1].selected = true;
                        $("#jifengoodsSelect" ).selectpicker('refresh');
                    }
                }
            }
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addjifengoodsOrder = window.sessionStorage.getItem("addjifengoodsOrder");
        if (addjifengoodsOrder != null && addjifengoodsOrder != "" && addjifengoodsOrder != "null") {
            window.sessionStorage.removeItem('addjifengoodsOrder');
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("jifengoodsOrder/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#jifengoodsId").val(ruleForm.jifengoodsId);
    ...
    function huiyuanDataBind(){
        ...
        $("#shangjiaValue").val(ruleForm.shangjiaValue);
    }

    function jifengoodsDataBind(){

                    <!-- 把id赋值给当前表的id-->
        $("#jifengoodsId").val(ruleForm.id);
    ...
    function jifengoodsShowVideo() {
        $("#jifengoodsPhotoV").attr("src",ruleForm.jifengoodsPhoto);
    }
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationjifengoodsSelect();
