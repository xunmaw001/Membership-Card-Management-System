    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        if("用户".equals(role)){
            ...
            params.put("huiyuanId",huiyuan.getId());
        }
    ...
    */
    ...
    public R info(@PathVariable("id") Long id){
        ...
        if(liuyan !=null){
            ...
            //级联表
            HuiyuanEntity huiyuan = huiyuanService.selectById(liuyan.getHuiyuanId());
            if(huiyuan != null){
    ...
    */
    ...
    public R save(@RequestBody LiuyanEntity liuyan, HttpServletRequest request){
        ...
        if("会员".equals(role)){
            ...
            liuyan.setHuiyuanId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
            liuyanService.insert(liuyan);
            return R.ok();
        }else{
            return R.error(511,"您不能新增留言");
        }
    }
